...
URL = "https://zenfilter.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://zenfilter.onrender.com".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://zenfilter.onrender.com/".format(FQDN)
else:
    URL = "https://zenfilter.onrender.com/".format(FQDN)
