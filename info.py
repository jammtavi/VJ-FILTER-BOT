...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002099263541')
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'ab6b6448143f9b5439c05953cd4b87f9cf250886')
...
URL = "https://zenfilter-a15839f7efae.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://zenfilter-a15839f7efae.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://zenfilter-a15839f7efae.herokuapp.com/".format(FQDN)
else:
    URL = "https://zenfilter-a15839f7efae.herokuapp.com/".format(FQDN)
